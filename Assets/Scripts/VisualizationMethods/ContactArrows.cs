...
{
    public class ContactArrows : MonoBehaviour, IVisualizationMethod
    {
        ...
        private GameObject CreateNewArrow(ContactPoint contactPoint)
        {
            ...
            newArrow.transform.localScale = new Vector3(newArrow.transform.localScale.x, 0.5f, newArrow.transform.localScale.z);
            return newArrow;
        }
